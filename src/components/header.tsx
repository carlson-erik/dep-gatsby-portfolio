...
const Navigation = styled.nav<{ showMenu: boolean }>`
  display: flex;
  margin: 0;
  padding: 0;
...
const NavigationLink = styled(Link)<{ showMenu: boolean }>`
  font-size: 0.75rem;
...
const SocialContainer = styled.div<{ showMenu: boolean }>`
  flex-grow: 1;
  display: flex;
  gap: 0.5rem;
    ...
    <Container>
      ...
      <NavigationContainer showMenu={showMenu}>
        <Navigation showMenu={showMenu}>
          <NavigationLink showMenu={showMenu} to="/projects">
            Projects
          </NavigationLink>
          <NavigationLink showMenu={showMenu} to="/experience">
            Experience
          </NavigationLink>
          <NavigationLink showMenu={showMenu} to="/blog">
            Blog
          </NavigationLink>
        </Navigation>
        <SocialContainer showMenu={showMenu}>
          <SocialLink
            href="#email"
            target="_blank"
